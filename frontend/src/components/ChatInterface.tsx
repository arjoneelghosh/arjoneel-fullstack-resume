...
export function ChatInterface({ isOpen, onClose }: ChatInterfaceProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome',
      text: "Hello! I'm Arjoneel Ghosh's AI representative and eager to help you navigate or state your doubt regarding any of the project. I can assist you in English, Hindi and Bengali.",
      sender: 'bot',
    },
  ]);
